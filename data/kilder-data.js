window.KILDER_STATUS = {
 "opdateret": "2026-08-16T19:55:23.853523+00:00",
 "artikler_i_alt": 86,
 "kilder": [
  {
   "navn": "TechCrunch AI",
  ...
  },
  {
   ...
   "seneste": [
    {
     "rubrik": "CheapCredits sælger AI-kreditter med 40 % rabat",
    ...
    {
     "rubrik": "Nature: AI forkorter vejen til nye lægemidler",
    ...
    {
     "rubrik": "AI husker bedre end mennesker - derfor vinder den",
    ...
    {
     "rubrik": "AI-arbejde minder mere om ledelse end kodning",
    ...
    {
     "rubrik": "AI by Hand lærer dig AI uden skærm",
    ...
    {
     "rubrik": "Google's HEIR gør krypteret AI til virkelighed",
