...
self.addEventListener("fetch", event => {
  ...
  event.respondWith(fetch(event.request).catch(() => new Response(
    '<!doctype html><html lang="da"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Du er offline · AI-nyheder</title><body style="font:18px/1.7 system-ui,sans-serif;background:#0c0e12;color:#f2f3f5;max-width:36rem;margin:12vh auto;padding:24px"><h1>Du er offline</h1><p>AI-nyheder kræver internet. Tjek forbindelsen, og prøv igen.</p><a href="/" style="color:#d5ff5f">Prøv igen →</a></body></html>',
